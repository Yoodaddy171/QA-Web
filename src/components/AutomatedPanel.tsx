...
export function AutomatedPanel({
  ...
  return (
    <div className="min-w-0 space-y-5 overflow-x-hidden">
        ...
        <Card variant="glass" padding="none" className="border-l-4 border-l-cyan-500 hover:bg-cyan-500/[0.03] transition-all duration-300">
          <CardContent className="flex items-center gap-3 p-4">
            ...
            <div>
              ...
              <p className="text-[10px] font-black uppercase tracking-wider text-cyan-600 dark:text-cyan-400">Vault Scenarios</p>
            </div>
          </CardContent>
        </Card>
        <Card variant="glass" padding="none" className="border-l-4 border-l-emerald-500 hover:bg-emerald-500/[0.03] transition-all duration-300">
          <CardContent className="flex items-center gap-3 p-4">
            ...
            <div>
              ...
              <p className="text-[10px] font-black uppercase tracking-wider text-emerald-600 dark:text-emerald-400">Manual Artifacts</p>
            </div>
          </CardContent>
        </Card>
        <Card variant="glass" padding="none" className="border-l-4 border-l-amber-500 hover:bg-amber-500/[0.03] transition-all duration-300">
          <CardContent className="flex items-center gap-3 p-4">
            ...
            <div>
              ...
              <p className="text-[10px] font-black uppercase tracking-wider text-amber-600 dark:text-amber-400">Latest Run</p>
            </div>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="flex flex-col gap-3 rounded-2xl border border-border/40 bg-card/65 p-4 shadow-sm backdrop-blur-md sm:flex-row sm:items-center sm:justify-between">
        <div className="flex min-w-0 flex-1 flex-col gap-2 sm:flex-row">
          ...
          <Select value={filterModule} onValueChange={setFilterModule}>
            ...
            <SelectContent className="border border-border/50 bg-card/95 backdrop-blur-xl shadow-lg">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-52 border border-border/50 bg-card/95 backdrop-blur-xl rounded-2xl shadow-xl">
      ...
      {filteredItems.length === 0 ? (
        <div className="flex flex-col items-center justify-center space-y-2 rounded-2xl border border-dashed border-border/60 bg-card/65 py-20 backdrop-blur-md shadow-sm text-center">
          ...
          {items.length === 0 && (
            <Button
              ...
              onClick={onRefresh}
              disabled={loading}
              className="mt-3 h-9 gap-2 rounded-xl border-primary/30 bg-primary/10 px-4 text-[10px] font-black uppercase tracking-wider text-primary hover:bg-primary/15"
            >
              ...
              <Table>
                <TableHeader className="sticky top-0 z-10 bg-secondary/95 backdrop-blur-sm">
                   <TableRow className="border-border/30 hover:bg-transparent">
                    ...
                    <TableHead className={getColumnClass('type', 'w-[86px] text-[10px] font-black uppercase tracking-widest text-muted-foreground')}>Type</TableHead>
                    ...
                    <TableHead className="w-[80px] text-[10px] font-black uppercase tracking-widest text-muted-foreground">Action</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
