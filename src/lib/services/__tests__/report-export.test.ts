...
const report: ReportData = {
  ...
  metrics: {
    ...
    byPriority: [],
    byStatus: [],
    bugSummary: { total: 0, critical: 0, open: 0, overdue: 0, reported: 0, fixing: 0, readyToRetest: 0, fixed: 0, byModule: [] },
    testRunSummary: { totalPlanned: 0, totalCompleted: 0, totalPassed: 0, totalFailed: 0, totalBlocked: 0, totalNotRun: 0, unfinishedRuns: 0, activeRuns: [] },
    appendix: [],
  },
