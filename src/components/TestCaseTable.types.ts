...
export interface TestCaseTableProps {
  ...
  openCreateDialog: () => void; openAIDialog: () => void; openImportDialog: () => void; handleImportExcel: (event: React.ChangeEvent<HTMLInputElement>) => void; handleExportExcel: (format?: string, testCaseIds?: string[]) => void; refreshList: () => void; toggleSelectAll: () => void; toggleSelect: (id: string) => void; clearSelection: () => void; toggleSort: (field: string) => void;
