...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      formatters={{
        formatMonthDropdown: (date) => date.toLocaleString(props.locale?.code, { month: "short" }),
        ...formatters,
      }}
      classNames={{
        ...
        caption_label: cn("flex h-8 items-center gap-1 rounded-md px-2 text-sm font-medium select-none [&>svg]:size-3.5 [&>svg]:text-muted-foreground", defaultClassNames.caption_label),
      ...
      components={{
        ...
        DayButton: ({ ...dayProps }) => <CalendarDayButton localeCode={props.locale?.code} {...dayProps} />,
        ...components,
      }}
      {...props}
    />
