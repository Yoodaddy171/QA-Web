    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-4xl max-h-[90vh] flex flex-col p-0 overflow-hidden bg-background text-foreground">
                            ...
                            <div className="rounded-xl border border-border/60 bg-secondary/30 p-4">
                              ...
                              <div className="grid grid-cols-2 gap-4">
                                <div>
                                  ...
                                  <Badge className={cn(viewTestCase.actualResult === 'As Expected' ? 'border-emerald-500/25 bg-emerald-500/10 text-emerald-300' : viewTestCase.actualResult === 'Not As Expected' ? 'border-red-500/25 bg-red-500/10 text-red-300' : 'border-slate-500/20 bg-slate-500/10 text-slate-300')}>
                            ...
                            <div className="flex flex-wrap items-center gap-1.5 bg-muted/70 p-1 rounded-xl border border-border dark:bg-secondary/50 dark:border-border/60">
                              <Button
                                ...
                                className={cn(
                                  ...
                                  "bg-gradient-to-r from-violet-600/20 to-indigo-600/20 text-violet-300 hover:from-violet-600/30 hover:to-indigo-600/30 border border-violet-500/30"
                                )}
                              ...
                              <Button
                                ...
                                className={cn(
                                  ...
                                  activeDevLogTab === 'execution' ? 'bg-teal-500/15 text-teal-200 shadow-xl hover:bg-teal-500/20' : 'text-slate-500 hover:text-slate-300'
                                )}
                              ...
                              <Button
                                ...
                                className={cn(
                                  "h-8 rounded-lg px-2.5 text-[10px] font-black uppercase tracking-widest",
                                  activeDevLogTab === 'console' ? 'bg-teal-500/15 text-teal-200 shadow-xl hover:bg-teal-500/20' : 'text-slate-500 hover:text-slate-300'
                                )}
                              ...
                              <Button
                                ...
                                className={cn(
                                  "h-8 rounded-lg px-2.5 text-[10px] font-black uppercase tracking-widest",
                                  activeDevLogTab === 'network' ? 'bg-teal-500/15 text-teal-200 shadow-xl hover:bg-teal-500/20' : 'text-slate-500 hover:text-slate-300'
                                )}
                              ...
                              <Button
                                ...
                                className={cn(
                                  ...
                                  (loadedRunLabel === 'current' || loadedRunLabel === 'live') ? 'bg-teal-600 text-white shadow-lg hover:bg-teal-500' : 'text-slate-500 hover:text-teal-400 hover:bg-teal-500/10'
                                )}
                              ...
                              <Button
                                ...
                                className={cn(
                                  ...
                                  loadedRunLabel === 'previous' ? 'bg-indigo-600 text-white shadow-lg hover:bg-indigo-500' : 'text-slate-500 hover:text-indigo-400 hover:bg-indigo-500/10'
                                )}
                                    ...
                                    viewTestCase.stepLogs.split('\n').map((line, index) => {
                                      ...
                                      return (
                                        <div key={`${index}-${line}`} className="flex gap-4 hover:bg-white/5 transition-colors px-2 py-0.5 rounded group">
                                          ...
                                          <span className={cn(isError ? 'text-rose-400 font-bold' : isWarning ? 'text-amber-400' : isInfo ? 'text-cyan-400' : 'text-emerald-400/90')}>
                                            {line}
                                          </span>
                                        </div>
                                      );
                                ...
                                <div className="divide-y divide-slate-800/50">
                                  {consoleLogs.length === 0 ? (
                                    ...
                                    consoleLogs.map((log, index) => {
                                      ...
                                      return (
                                        <div key={logId} className={cn("group", isError ? 'bg-rose-950/20' : isWarning ? 'bg-amber-950/20' : 'hover:bg-white/5')}>
                                          <div
                                          ...
                                          >
                                            ...
                                            <div className="flex-1 break-all">
                                              <span className={cn(isError ? 'text-rose-400' : isWarning ? 'text-amber-400' : 'text-emerald-400/90')}>
                                                {typeof log.log === 'object' ? `${JSON.stringify(log.log).substring(0, 200)}...` : String(log.log ?? '')}
                                              </span>
                                            </div>
                                            {typeof log.log === 'object' && (
                                              <ChevronDown className={cn("w-3.5 h-3.5 text-slate-600 transition-transform", expandedLogId === logId && "rotate-180")} />
                                            )}
                                          </div>
                                          <AnimatePresence>
        ...
        {isRecordingFullscreen && manualRecording?.frames?.length && (
          <div
            className={cn(
              "fixed inset-0 z-[80] flex bg-background text-slate-100 transition-opacity duration-200",
          ...
          >
            ...
            <div className={cn("flex min-w-0 flex-1 flex-col transition duration-200", isClosingRecordingFullscreen ? 'scale-[0.985]' : 'scale-100')}>
              ...
              <div
                ...
                className={cn(
                  "flex min-h-0 flex-1 overflow-auto bg-black p-4",
            ...
            <div className={cn("flex w-[420px] shrink-0 flex-col border-l border-border bg-background transition duration-200 xl:w-[520px]", isClosingRecordingFullscreen ? 'translate-x-4' : 'translate-x-0')}>
              <div className="flex h-24 shrink-0 items-end justify-between gap-4 border-b border-border px-3 pb-3 pt-12 pr-16">
                ...
                <div className="flex rounded-md bg-muted p-1">
                  <Button
                    ...
                    variant="ghost"
                    size="sm"
                    className={cn("h-7 px-2 text-[10px] font-bold", activeDevLogTab === 'console' ? 'bg-teal-500/15 text-teal-100 hover:bg-teal-500/20' : 'text-slate-400 hover:text-white')}
                    onClick={() => setActiveDevLogTab('console')}
                  >
                    CONSOLE
                  </Button>
                  <Button
                    ...
                    variant="ghost"
                    size="sm"
                    className={cn("h-7 px-2 text-[10px] font-bold", activeDevLogTab === 'network' ? 'bg-teal-500/15 text-teal-100 hover:bg-teal-500/20' : 'text-slate-400 hover:text-white')}
                    onClick={() => setActiveDevLogTab('network')}
                  >
                    NETWORK
                  </Button>
                      ...
                      consoleLogs.map((log, index) => {
                        ...
                        return (
                          <button
                            key={logId}
                            type="button"
                            className={cn("grid w-full grid-cols-12 gap-2 p-2 text-left hover:bg-white/5", isError ? 'bg-rose-950/20' : isWarning ? 'bg-amber-950/20' : '')}
                          ...
                          >
                            ...
                            <span className={cn("col-span-10 break-all text-[11px]", isError ? 'text-rose-300' : isWarning ? 'text-amber-300' : 'text-emerald-300/90')}>
